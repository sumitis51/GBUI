...
We also have notes in [**our wiki**](https://github.com/gothinkster/groupbima-pwa/wiki) about how the various patterns used in this codebase and how they work (thanks [@thejmazz](https://github.com/thejmazz)!)
...
this.props.history.push('/input-form-health') For change routes programmatically!